...
public class ReversementResponse {
    ...
    public static class ReversementDetail {
        ...
        public int getReversedAmount() {
            return reversedAmount;
        }

        public void setReversedAmount(int reversedAmount) {
    ...
    public int getTotalPeriodicContributions() {
        return totalPeriodicContributions;
    }

    public void setTotalPeriodicContributions(int totalPeriodicContributions) {
        this.totalPeriodicContributions = totalPeriodicContributions;
    }
    ...
    public int getTotalReversedToFederation() {
        return totalReversedToFederation;
    }

    public void setTotalReversedToFederation(int totalReversedToFederation) {
        this.totalReversedToFederation = totalReversedToFederation;
    }

    public List<ReversementDetail> getDetails() {
        return details;
    }

    public void setDetails(List<ReversementDetail> details) {
